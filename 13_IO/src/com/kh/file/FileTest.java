...
//		존재하지 않는 경로를 제시하면 IOException 발생
		...
		System.out.println("상대 경로 : " + newFile.getPath());
		System.out.println("파일 용량 : " + newFile.length());
		System.out.println("파일 존재 여부 : " + newFile.exists());
		System.out.println("파일 여부 : " + newFile.isFile());
