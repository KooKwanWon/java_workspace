...
public class A_Consumer {
	...
	public void method2() {
		...
		biConsumer.accept("BiConsumers는 ", "두 개의 매개값을 받아서 소비한다.");
	}
//	IntConsumer
//	LongConsumer
//	DoubleConsumer
	public void method3() {
		DoubleConsumer dConsumer = value
				-> System.out.println("DoubleConsumer는 Double 타입의 값을 받아서 소비한다 " + value);
...
//	ObjDoubleConsumer<T>
	...
	public void method4() {
		ObjIntConsumer<String> objIntConsumer = (str, value)
				-> System.out.println("ObjIntConsumer는 두개의 매개값을 받아서 소비한다. " +str + value);
