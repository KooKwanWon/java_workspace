...
import com.kh.lambda.practice.MathInterface;
...
public class Application {
	...
	public static void main(String[] args) {
		...
		MathInterface devideLambda = (int x, int y) -> {return x / y; };
		
		System.out.println(plusLambda.clac(a, b));
		System.out.println(minusLambda.clac(a, b));
		System.out.println(multipleLambda.clac(a, b));
		System.out.println(devideLambda.clac(a, b));
