...
public class Notebook extends Product {/*extends Object*/
	...
	public Notebook(String brand, String pCode, String name, int price, String cpu) {
		...
		// super : 해당 객체 부모의 객체의 주소를 담고 있음
		
		//1.super. 을 통해서 부모의 멤버변수에 직접 접근
//		super.brand = brand; // 부모가 product - 직접 접근할 수 없음
//		super.pCode = pCode;//부모가 default - 같은 패키지에 있어야만 접근가능
//		super.name = name;// 부모가 protected - 상속관계일때 자식 객체에서 직접 접근이 불가능
//		super.price= price; // public - 어디서든 접근이 가능
