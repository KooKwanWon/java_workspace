...
//java.lang 패키지에 있는 클래스와 인터페이스는 import없이 사용 할 수 있다.
...
public class A_String {
	...
	/*
	 * String 클래스 - 불변의 클래스 : 객체를 생성하면 변경할 수 없다. - 변경이 적고 읽기가 많은 경우에 사용하는 것이 좋다. -
...
//		hashCode() 메서드는 String 클래스에서 오버라이딩
		...
		System.out.println("str4.hashCode() : " + str4.hashCode()); // true
		System.out.println();
...
//			- 문자열에서 old 문자를 new 문자로 변경된 새로운 문자열을 생상해서 리턴
...
//		9. static valueOf([기본자료형, 문자배열, 객체]) : String
//		-정적 메서드 매개변수로 입력받는 값들을 문자열로 변경해서 리턴
...
//	- StringBuilder & StringBuffer의 차이점 : 동기화가 되느냐 안되느냐
...
//		- 문자열의 순서를 역으로 바꾼다.
		...
		// IPA avaJ
		sb2.insert(0, "I").delete(1,2).delete(4,12).insert(1, "PA ").insert(7, "J");
	...
	public void method5() {
		...
		//구분자를 이용하여 문자열 분리
		String str = "Java, Oracle, JDBC, HTML, CSS, JavaScript, jQuery, Servlet"
				+ ", JSP, MyBatics, Spring, React";
		
		//1. String 클래스의 split 메서드를 이용하는 방법
		// split(String regex) : 입력받는 구분자로 문자열을 분리해서 문자열의 배열로 담아서 리턴
